...
Future<void> main() async {
  ...
  if (Platform.isAndroid) {
    final handler = KikoeruAudioHandler(container.read(playbackProvider.notifier));
    await AudioService.init(
      builder: () => handler,
      config: const AudioServiceConfig(
        androidNotificationChannelId: 'top.voicehub.kikoeru.channel.audio',
  ...
  runApp(UncontrolledProviderScope(
    container: container,
    child: const KikoeruApp(),
  ));
}

class KikoeruApp extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MaterialApp(
      ...
      theme: buildKikoeruTheme(settings),
