...
- 设置分六类二级页（外观 / 音频与增益 / 主界面 / 数据 / 音乐目录 / 关于），不再从头滚到尾
- 侧边栏可折叠
...
macOS 与 Android 安装包在 [Releases](https://github.com/michiru233/hiko/releases) 页面，当前现役版本 [v1.87.0](https://github.com/michiru233/hiko/releases/tag/v1.87.0)。
